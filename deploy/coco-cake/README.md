...
| `baro-inventory` | يبني جذر المستودع |
| `baro-inventory-qmpp` | يبني جذر المستودع (حساب شخصي) |
| `baro-coupons` | **يفشل في كل دفعة** — يحتاج مراجعة أو حذفاً |

المشاريع الثلاثة الأخيرة تبني جذر المستودع، فتنشر باروو و COCO CAKE معاً
على `/sweet-cost/`. إن أردت COCO CAKE مستوراً عن العلن، فالمكان الصحيح
للمعالجة هو تلك المشاريع لا هذا المجلد.
