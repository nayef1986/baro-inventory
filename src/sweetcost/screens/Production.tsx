    ...
    <>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1fr_300px] gap-5 items-start">
        ...
        <div className="flex flex-col gap-4">
          <div className="bg-bark rounded-2xl p-5 text-[#f5efe6]">
            ...
            <p className="m-0 mt-4 text-[12.5px] leading-relaxed text-[#a99783]">
...
function DarkRow({
  ...
  const color = tone === 'bad' ? 'text-[#f0a28e]' : tone === 'good' ? 'text-[#8fd3b8]' : ''
  return (
    <div className={`flex justify-between items-baseline ${bordered ? 'border-t border-bark-3 pt-2.5' : ''}`}>
      <dt className="text-[13px] text-[#bfae99]">{label}</dt>
